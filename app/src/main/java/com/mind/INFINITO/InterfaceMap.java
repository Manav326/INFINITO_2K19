...
import com.mind.INFINITO.map.staticMap;
...
public class InterfaceMap extends AppCompatActivity implements OnMapReadyCallback     {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        startActivity(new Intent(InterfaceMap.this, staticMap.class));
                    }
                }, 2000);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        task.addOnFailureListener(InterfaceMap.this, new OnFailureListener() {
            @Override
            public void onFailure(@Nullable Exception e) {
                if(e instanceof ResolvableApiException){
                    ResolvableApiException resolvable = (ResolvableApiException) e;
                    try {
                        resolvable.startResolutionForResult(InterfaceMap.this, 51);
    ...
    private void getDeviceLocation(){
        mFusedLocationProviderClient.getLastLocation()
                .addOnCompleteListener(new OnCompleteListener<Location>() {
                    @Override
                    public void onComplete(@Nullable Task<Location> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(InterfaceMap.this, "unable to get last location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
